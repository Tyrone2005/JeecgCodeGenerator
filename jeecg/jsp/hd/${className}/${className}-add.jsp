...
<body class="add-dis">
    <form id="formobj" class="form-horizontal m-t" role="form" action="${classNameLower}Controller.do?doAdd" name="formobj" method="post">
...
<#macro generateFields>
    ...
    <#if "id" != column.columnNameLower && "createBy" != column.columnNameLower && "createDate" != column.columnNameLower && "updateBy" != column.columnNameLower && "updateDate" != column.columnNameLower && "deleteFlag" != column.columnNameLower>
                <div class="form-group draggable">
                    ...
                    <div class="col-sm-4">
                        <input id="${column.columnNameLower}" name="${column.columnNameLower}" type="text" class="form-control input-sm">
