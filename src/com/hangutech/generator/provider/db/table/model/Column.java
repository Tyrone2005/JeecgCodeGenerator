package com.hangutech.generator.provider.db.table.model;

import java.util.List;

import com.hangutech.generator.GeneratorProperties;
import com.hangutech.generator.provider.db.table.TableFactory;
import com.hangutech.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.hangutech.generator.provider.db.table.model.util.ColumnHelper;
import com.hangutech.generator.util.GLogger;
import com.hangutech.generator.util.StringHelper;
import com.hangutech.generator.util.TestDataGenerator;
import com.hangutech.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.hangutech.generator.util.typemapping.DatabaseDataTypesUtils;
import com.hangutech.generator.util.typemapping.JavaPrimitiveTypeMapping;
import com.hangutech.generator.util.typemapping.JdbcType;
...
public class Column {
    ...
    public Column(Table table, int sqlType, String sqlTypeName, String sqlName, int size, int decimalDigits,
        ...
        _remarks = remarks;
        if (table.getExportedKeys() != null && table.getExportedKeys().getHasImportedKeyColumn(sqlName)) {
            this._isFk = true;
        }
        if (table.getImportedKeys() != null && table.getImportedKeys().getHasImportedKeyColumn(sqlName)) {
            this._isFk = true;
        }
        GLogger.trace(sqlName + " isFk -> " + _isFk);
    ...
    public String getJdbcSqlTypeName() {
        ...
        // RuntimeException("jdbcSqlTypeName is null column:"+getSqlName()+" sqlType:"+getSqlType());
        return result;
    }
    ...
    /**
     * 得到简短的java.lang.javaType,如java.lang.String将返回String,而非java.lang包的,
     * 将直接返回getJavaType()
     * 
     * @return
     */
